...
AutoModelForScore.from_pretrained("PKU-Alignment/beaver-7b-unified-reward", cache_dir=CACHE_DIR)
AutoModelForScore.from_pretrained("PKU-Alignment/beaver-7b-unified-cost", cache_dir=CACHE_DIR)
